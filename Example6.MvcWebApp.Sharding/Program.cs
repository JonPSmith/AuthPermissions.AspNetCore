...
builder.Services.RegisterAuthPermissions<Example6Permissions>(options =>
{
    ...
    .AddRolesPermissionsIfEmpty(Example6Example3AppAuthSetupData.RolesDefinition)
    .AddTenantsIfEmpty(Example6Example3AppAuthSetupData.TenantDefinition)
    .AddAuthUsersIfEmpty(Example6Example3AppAuthSetupData.UsersRolesDefinition)
