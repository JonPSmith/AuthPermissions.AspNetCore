...
public class TestTenantAdminServicesSharding
{
    ...
    public async Task TestAddSingleTenantAsyncOk()
    {
        ...
        var service = new AuthTenantAdminService(context,
            _authOptionsSingleSharding, new StubDefaultLocalizerWithLogging<ResourceLocalize>("en"),
            tenantChange,  null);
    ...
    public async Task TestAddHierarchicalTenantAsyncToExistingParentNoShardingParamsOk()
    {
        ...
        var tenantChange = new StubITenantChangeServiceFactory();
        var service = new AuthTenantAdminService(context,
            _authOptionsHierarchicalSharding, new StubDefaultLocalizerWithLogging<ResourceLocalize>("en"),
            tenantChange, null);
