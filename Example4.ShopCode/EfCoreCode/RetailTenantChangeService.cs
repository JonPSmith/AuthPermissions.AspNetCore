...
namespace Example4.ShopCode.EfCoreCode
{
    public class RetailTenantChangeService : ITenantChangeService
    {
        ...
        /// 
        /// In this example that means I create a new RetailOutlet, but it might not be a shop
        /// </summary>
        ...
        {
            appTransactionContext.Add(new RetailOutlet(tenantId, fullTenantName, dataKey));
